import {
  ...
  PinIcon, PhoneIcon, MailIcon, ClockIcon, ChevronRight,
} from '@/app/ui/Icon';
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
              ...
              <div className="flex items-center gap-2">
                {socialLinks.map(({ Icon, href, label }) => (
                  <a key={label} href={href} target="_blank" rel="noopener noreferrer" aria-label={label}
                    className="w-9 h-9 rounded-full flex items-center justify-center transition-all duration-200 hover:bg-[#2E6DE7] hover:text-white"
          ...
          <div>
            ...
            <ul className="flex flex-col gap-4 text-sm" style={{ color: 'rgba(255,255,255,0.5)' }}>
              ...
              <li className="flex items-center gap-2.5">
                ...
                <a href="tel:+260762062641" className="transition-colors hover:text-white">+260 762 062 641</a>
              </li>
              <li className="flex items-center gap-2.5">
                <span style={{ color: '#2E6DE7' }}><MailIcon /></span>
                <a href="mailto:mulungushisdapcmpublicity@gmail.com" className="transition-colors hover:text-white">mulungushisdapcmpublicity@gmail.com</a>
              </li>
              <li className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <div className="flex flex-col gap-2.5">
              ...
              />
              <div>
                <Button href="/newsletter" className="w-full" variant="primary" size="md">Subscribe</Button>
              </div>
            </div>
          </div>
        </div>
